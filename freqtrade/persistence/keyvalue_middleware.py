...
from freqtrade.persistence.models import KeyValue
...
class KeyValues():
    ...
    def get_kval(key: Optional[str] = None, trade_id: Optional[int] = None) -> List[KeyValue]:
        ...
        if KeyValues.use_db:
            ...
            if key is not None:
                filtered_kvals = [kval for kval in KeyValues.kvals if (kval.kv_key.casefold() == key.casefold())]
            return filtered_kvals
    ...
    def set_kval(key: str, value: Any, trade_id: Optional[int] = None) -> None:
        ...
        if KeyValues.use_db and value_db is not None:
            ...
            kv_index = 0
            for index, kval in KeyValues.kvals:
